...
$( "#modal-form" ).on( "submit", function( e ) {
    ...
    if ( $( "#exampleModalLabel" ).data( "news" ) !== undefined ) {
        ...
        var News = Parse.Object.extend( "Opinions" );
        news = new News();
    }
...
$( "table tbody" ).click( function( e ) {
    ...
    if ( el.data( "newsedit" ) !== undefined ) {
        ...
        $( "#opinionNameInput" ).val( news.get( "name" ) );
        $( "#opinionContentInput" ).val( news.get( "content" ) );
        $( "#addNewsModal" ).modal( {} );
    }
...
// Init
new Parse.Query( "Opinions" ).ascending("createdAt").find().then( init ).catch( showError );
